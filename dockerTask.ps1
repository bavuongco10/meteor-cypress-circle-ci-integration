...
.PARAMETER Clean
Removes the image meteor-cypress-circle-ci-integration and kills all containers based on that image.
...
Build a Docker image named meteor-cypress-circle-ci-integration
#>
...
$imageName="meteor-cypress-circle-ci-integration"
$projectName="meteorcypresscircleciintegration"
$publicPort=3000
